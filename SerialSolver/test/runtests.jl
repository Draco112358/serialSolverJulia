...
# !!! Main.UserApp is configured as an alias for Main.SerialSolver and you might encounter it in some tests
using Main.SerialSolver, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "SerialSolver tests" begin
  @includetests ARGS
end
