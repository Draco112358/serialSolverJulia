...
function Integ_sup_sup(xc1, yc1, zc1, xc2, yc2, zc2, a1, b1, c1, a2, b2, c2)
    ...
    elseif sum_supp == 3
        ...
        if is_surf_v1 == 1
            if supp_x2 == 1
                integ = a1 * b2 * integ_line_surf_ortho([z1v[1], z1v[end]], [y1v[1], y1v[end]], xc1, [z2v[1], z2v[end]], yc2, [x2, x2])
            elseif supp_y2 == 1
                integ = a1 * a2 * integ_line_surf_para([y1v[1], y1v[end]], [z1v[1], z1v[end]], xc1, [y2, y2], zc2, xc2)
            else
                integ = a1 * c2 * integ_line_surf_para([y1v[1], y1v[end]], [z1v[1], z1v[end]], xc1, [y2v[1], y2v[end]], zc2, xc2)
            end
        else
            if supp_x1 == 1
                integ = b1 * b2 * integ_line_surf_para([x1v[1], x1v[end]], [z1v[1], z1v[end]], yc1, [x2, x2], zc2, yc2)
            elseif supp_y1 == 1
                integ = b1 * a2 * integ_line_surf_ortho([z1v[1], z1v[end]], [x1v[1], x1v[end]], yc1, [z2v[1], z2v[end]], xc2, [y2, y2])
            else
                integ = b1 * c2 * integ_line_surf_para([x1v[1], x1v[end]], [y1v[1], y1v[end]], yc1, [x2, x2], yc2, zc2)
            end
        end
    else
        if supp_x1 == 1
            ...
            elseif supp_y2 == 1
                integ = a1 * b2 * integ_surf_surf_ortho([z1v[1], z1v[end]], [y1v[1], y1v[end]], xc1, [z2v[1], z2v[end]], yc2, [x2, x2])
            else
                integ = a1 * c2 * integ_surf_surf_ortho([y1v[1], y1v[end]], [z1v[1], z1v[end]], xc1, [y2v[1], y2v[end]], zc2, [x2, x2])
            end
        elseif supp_y1 == 1
            if supp_x2 == 1
                integ = b1 * a2 * integ_surf_surf_ortho([z1v[1], z1v[end]], [x1v[1], x1v[end]], yc1, [z2v[1], z2v[end]], xc2, [y2, y2])
            elseif supp_y2 == 1
                integ = b1 * b2 * integ_surf_surf_para([x1v[1], x1v[end]], [z1v[1], z1v[end]], yc1, [x2v[1], x2v[end]], [z2v[1], z2v[end]], yc2)
            else
                integ = b1 * c2 * integ_surf_surf_ortho([x1v[1], x1v[end]], [z1v[1], z1v[end]], yc1, [x2v[1], x2v[end]], zc2, [y2, y2])
            end
        else
            if supp_x2 == 1
...
function integ_line_surf_para(x1v, y1v, z1, x2, y2v, z2)
    sol = 0
    for c1 = 1:2
        x1 = x1v[c1]
        for c2 = 1:2
