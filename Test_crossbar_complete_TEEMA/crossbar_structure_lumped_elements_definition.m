function lumped_elements=crossbar_250_structure_lumped_elements_definition()

% define the lumped elements position in meters
num_le=7;
le_end=zeros(num_le,3);
le_start=zeros(num_le,3);
lumped_elements.value=[1e-6*ones(5,1);50*ones(2,1)];
...
le_end(k,:)=[0 0.475 0.0312]*1e-3;k=k+1;
