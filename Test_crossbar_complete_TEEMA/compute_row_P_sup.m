function row=compute_row_P_sup(centers,centers2,sx,sy,sz,caser,caser2)
...
function integ=Integ_sup_sup(xc1, yc1, zc1, xc2, yc2, zc2, a1,b1,c1, a2,b2,c2)
...
function supp_dim=check_condition_P(eps1,eps2,eps3,eps4,Sup1,Sup2,max_d,min_R,size_dim,other_dim1,other_dim2)
...
function sol = integ_surf_surf_ortho(x1v,y1v,z1,x2v,y2,z2v)
