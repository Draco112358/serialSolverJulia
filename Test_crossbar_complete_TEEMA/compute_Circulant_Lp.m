function FFTCLp=compute_Circulant_Lp(circulant_centers,escalings,Nx,Ny,Nz)
...
time_Lp=toc;
disp(['Lp computation ended. Elapsed time = ' num2str(time_Lp)])

end

function Cout=store_circulant(row_Lp,Nx,Ny,Nz)
i1x=1:Nx;
i2x=Nx+2:2*Nx;
i3x=Nx:-1:2;
