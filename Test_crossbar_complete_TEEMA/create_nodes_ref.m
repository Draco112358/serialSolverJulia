function [nodes,nodes_red,nodes_reused_clean]=create_nodes_ref(grids,num_full_vox,external_grids,mapping_vols,dominant_list)
...
nodes=zeros(num_full_vox,1);
lista_nod=zeros(num_full_vox,1);
cont_d=0;

for ka=1:length(dominant_list)
    k=dominant_list(ka);
...
nodes_reused=zeros(num_full_vox,1);

cont_reu=0;
for ka=1:length(non_domin_list)
    k=non_domin_list(ka);
...
function [nodo_shared,val_nodo]=bin_search_mod(nodes_to_see,nodes_red_dom)
...
function nodes=build_nodes(c1, c2, c3, Nx, Ny)

nodes=zeros(26,1);
k=1;
nodes(k,:)=From_3D_to_1D(c1-1, c2-1, c3-1, Nx, Ny);k=k+1;
nodes(k,:)=From_3D_to_1D(c1-1, c2-1, c3, Nx, Ny);k=k+1;
nodes(k,:)=From_3D_to_1D(c1-1, c2-1, c3+1, Nx, Ny);k=k+1;
nodes(k,:)=From_3D_to_1D(c1, c2-1, c3-1, Nx, Ny);k=k+1;
nodes(k,:)=From_3D_to_1D(c1, c2-1, c3, Nx, Ny);k=k+1;
nodes(k,:)=From_3D_to_1D(c1, c2-1, c3+1, Nx, Ny);k=k+1;
nodes(k,:)=From_3D_to_1D(c1+1, c2-1, c3-1, Nx, Ny);k=k+1;
nodes(k,:)=From_3D_to_1D(c1+1, c2-1, c3, Nx, Ny);k=k+1;
nodes(k,:)=From_3D_to_1D(c1+1, c2-1, c3+1, Nx, Ny);k=k+1;

nodes(k,:)=From_3D_to_1D(c1-1, c2, c3-1, Nx, Ny);k=k+1;
nodes(k,:)=From_3D_to_1D(c1-1, c2, c3, Nx, Ny);k=k+1;
nodes(k,:)=From_3D_to_1D(c1-1, c2, c3+1, Nx, Ny);k=k+1;
nodes(k,:)=From_3D_to_1D(c1, c2, c3-1, Nx, Ny);k=k+1;
nodes(k,:)=From_3D_to_1D(c1, c2, c3+1, Nx, Ny);k=k+1;
nodes(k,:)=From_3D_to_1D(c1+1, c2, c3-1, Nx, Ny);k=k+1;
nodes(k,:)=From_3D_to_1D(c1+1, c2, c3, Nx, Ny);k=k+1;
nodes(k,:)=From_3D_to_1D(c1+1, c2, c3+1, Nx, Ny);k=k+1;
