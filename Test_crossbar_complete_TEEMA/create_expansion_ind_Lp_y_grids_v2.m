function Ind_out=create_expansion_ind_Lp_y_grids_v2(grids,map,l_ind,mapping_Vox,nodes,nodes_red)
        ...
        for cont2=1:Ny-1
            ...
            for k=1:num_grids
                if(grids{k}(cont,cont2,cont3)) && (grids{k}(cont,cont2+1,cont3))
                    ...
                    nn2=bin_search(nodes(mapping_Vox(From_3D_to_1D(cont, cont2+1, cont3, Nx, Ny))),nodes_red);
