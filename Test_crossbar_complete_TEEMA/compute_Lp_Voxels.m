function Lp=compute_Lp_Voxels(centri_m,centri_n,sx,sy,sz,sx2,sy2,sz2,dc,is_sym)
...
function integ=Integ_vol_vol(x1v,y1v,z1v, x2v,y2v,z2v)
...
function supp_dim=check_condition(eps1,eps2,eps3,V1,V2,max_d,min_R,size_dim,other_dim1,other_dim2)
                ...
                for c5=1:2
                    ...
                    for c6=1:2
                        ...
                        term1 = ( (x1-x2)^4 + (y1-y2)^4 + (z1-z2)^4 ...
                            -3*(x1-x2)^2*(y1-y2)^2 - 3*(y1-y2)^2*(z1-z2)^2 -3*(x1-x2)^2*(z1-z2)^2)*R/60;
